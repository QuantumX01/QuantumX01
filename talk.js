...
else if(text === "家族は何人ですか？" || text === "家族は何人ですか？" || text === "家族は何人ですか"){
    speakGirl("5人です。");
...
//her ask questions from me 
    ...
    speakGirl("すみません、もう一度質問してください");
    document.getElementById("her").textContent = "すみません、もう一度質問してください";
    setTimeout(function(){
        isListening=true;
        recognition.start();
    },7000);
